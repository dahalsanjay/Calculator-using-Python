...
screen.maxsize(width = 453, height = 510)
screen.minsize(width = 365, height = 510)
screen.geometry('365x510')
...
# binding function
def on_enterbox(e):
    result_box.configure(bg = "red")
def on_leavebox(e):
    result_box.configure(bg = "orange")
...
result_box = Entry(screen, font = ("arial", 20, "italic bold"), bd = "30", justify = "right", bg="orange", textvariable = txt)
result_box.grid(row = 0, columnspan = 4)
...
btnsub = Button(screen, text = "-", font = ("arial", 20, "italic bold"),bd = 8, padx = 18, pady = 18, command = lambda: click('-'), activebackground = "green", activeforeground = "white", bg = "powder blue")
...
btnmul = Button(screen, text = "*", font = ("arial", 20, "italic bold"),bd = 8, padx = 18, pady = 18,command = lambda: click('*'), activebackground = "green", activeforeground = "white", bg = "powder blue")
...
btndiv =  Button(screen,text = "/", font = ("arial", 20, "italic bold"), bd = 8,padx =18, pady=18, command = lambda: click('/'), activebackground = "green", activeforeground = "white", bg = "powder blue")
btndiv.grid(row=4, column=3)


# advance 

btnsin = Button(screen, text = "sin", font = ("arial", 17, "italic bold"),bd = 8, padx = 13, pady = 15,command = cmsin, activebackground = "green", activeforeground = "white", bg = "powder blue")
btnsin.grid(row=0,column = 4,sticky = "w")

btncos = Button(screen, text = "cos", font = ("arial", 17, "italic bold"),bd = 8, padx = 9, pady = 22,command = cmcos, activebackground = "green", activeforeground = "white", bg = "powder blue")
btncos.grid(row=1,column = 4,sticky = "w")

btntan = Button(screen, text = "tan", font = ("arial", 17, "italic bold"),bd = 10.5, padx = 9, pady = 22,command = cmtan, activebackground = "green", activeforeground = "white", bg = "powder blue")
btntan.grid(row=2,column = 4,sticky = "w")

btnsqrt = Button(screen, text = "sqrt", font = ("arial", 17, "italic bold"),bd = 5.5, padx = 9, pady = 22,command = cmsqrt, activebackground = "green", activeforeground = "white", bg = "powder blue")
btnsqrt.grid(row=3,column = 4,sticky = "w")

btnlog = Button(screen, text = "log", font = ("arial", 17, "italic bold"),bd = 10.5, padx = 9, pady = 22,command = cmlog, activebackground = "green", activeforeground = "white", bg = "powder blue")
btnlog.grid(row=4,column = 4,sticky = "w")

# binding
result_box.bind('<Enter>', on_enterbox)
result_box.bind('<Leave>', on_leavebox)
...
btncos.bind('<Leave>', on_leaveecos)
